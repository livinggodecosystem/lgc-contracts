...
async function main() {
    ...
    wallets.ecosystemWallet === "0x0000000000000000000000000000000000000000"
        ? deployer.address
        : wallets.ecosystemWallet;

const communityWallet =
    wallets.communityWallet === "0x0000000000000000000000000000000000000000"
        ? deployer.address
        : wallets.communityWallet;

const liquidityWallet =
    wallets.liquidityWallet === "0x0000000000000000000000000000000000000000"
        ? deployer.address
        : wallets.liquidityWallet;

const developmentWallet =
    wallets.developmentWallet === "0x0000000000000000000000000000000000000000"
        ? deployer.address
        : wallets.developmentWallet;

const reserveWallet =
    wallets.reserveWallet === "0x0000000000000000000000000000000000000000"
        ? deployer.address
        : wallets.reserveWallet;

const teamWallet =
    wallets.teamWallet === "0x0000000000000000000000000000000000000000"
        ? deployer.address
        : wallets.teamWallet;
    //-------------------------------------------------
    // Deployment Object
